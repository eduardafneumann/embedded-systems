...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../SEProjetoFinalSingle.sopcinfo
...
# Design Name 
# setting SOPC_NAME is SEProjetoFinalSingle
SOPC_NAME := SEProjetoFinalSingle
...
# setting hal.stdout is UART0
ELF_PATCH_FLAG  += --stdout_dev UART0
