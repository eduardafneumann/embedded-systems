// SEProjetoFinalSingle_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module SEProjetoFinalSingle_mm_interconnect_0 (
		...
		output wire [0:0]  UART0_avalon_jtag_slave_address,        //          UART0_avalon_jtag_slave.address
		output wire        UART0_avalon_jtag_slave_write,          //                                 .write
		output wire        UART0_avalon_jtag_slave_read,           //                                 .read
		input  wire [31:0] UART0_avalon_jtag_slave_readdata,       //                                 .readdata
		output wire [31:0] UART0_avalon_jtag_slave_writedata,      //                                 .writedata
		input  wire        UART0_avalon_jtag_slave_waitrequest,    //                                 .waitrequest
		output wire        UART0_avalon_jtag_slave_chipselect      //                                 .chipselect
	);
	...
	wire  [19:0] cpu0_data_master_translator_avalon_universal_master_0_address;              // CPU0_data_master_translator:uav_address -> CPU0_data_master_agent:av_address
	...
	wire  [19:0] cpu0_instruction_master_translator_avalon_universal_master_0_address;       // CPU0_instruction_master_translator:uav_address -> CPU0_instruction_master_agent:av_address
	...
	wire  [31:0] uart0_avalon_jtag_slave_agent_m0_readdata;                                  // UART0_avalon_jtag_slave_translator:uav_readdata -> UART0_avalon_jtag_slave_agent:m0_readdata
	wire         uart0_avalon_jtag_slave_agent_m0_waitrequest;                               // UART0_avalon_jtag_slave_translator:uav_waitrequest -> UART0_avalon_jtag_slave_agent:m0_waitrequest
	wire         uart0_avalon_jtag_slave_agent_m0_debugaccess;                               // UART0_avalon_jtag_slave_agent:m0_debugaccess -> UART0_avalon_jtag_slave_translator:uav_debugaccess
	wire  [19:0] uart0_avalon_jtag_slave_agent_m0_address;                                   // UART0_avalon_jtag_slave_agent:m0_address -> UART0_avalon_jtag_slave_translator:uav_address
	wire   [3:0] uart0_avalon_jtag_slave_agent_m0_byteenable;                                // UART0_avalon_jtag_slave_agent:m0_byteenable -> UART0_avalon_jtag_slave_translator:uav_byteenable
	wire         uart0_avalon_jtag_slave_agent_m0_read;                                      // UART0_avalon_jtag_slave_agent:m0_read -> UART0_avalon_jtag_slave_translator:uav_read
	wire         uart0_avalon_jtag_slave_agent_m0_readdatavalid;                             // UART0_avalon_jtag_slave_translator:uav_readdatavalid -> UART0_avalon_jtag_slave_agent:m0_readdatavalid
	wire         uart0_avalon_jtag_slave_agent_m0_lock;                                      // UART0_avalon_jtag_slave_agent:m0_lock -> UART0_avalon_jtag_slave_translator:uav_lock
	wire  [31:0] uart0_avalon_jtag_slave_agent_m0_writedata;                                 // UART0_avalon_jtag_slave_agent:m0_writedata -> UART0_avalon_jtag_slave_translator:uav_writedata
	wire         uart0_avalon_jtag_slave_agent_m0_write;                                     // UART0_avalon_jtag_slave_agent:m0_write -> UART0_avalon_jtag_slave_translator:uav_write
	wire   [2:0] uart0_avalon_jtag_slave_agent_m0_burstcount;                                // UART0_avalon_jtag_slave_agent:m0_burstcount -> UART0_avalon_jtag_slave_translator:uav_burstcount
	wire         uart0_avalon_jtag_slave_agent_rf_source_valid;                              // UART0_avalon_jtag_slave_agent:rf_source_valid -> UART0_avalon_jtag_slave_agent_rsp_fifo:in_valid
	wire  [94:0] uart0_avalon_jtag_slave_agent_rf_source_data;                               // UART0_avalon_jtag_slave_agent:rf_source_data -> UART0_avalon_jtag_slave_agent_rsp_fifo:in_data
	wire         uart0_avalon_jtag_slave_agent_rf_source_ready;                              // UART0_avalon_jtag_slave_agent_rsp_fifo:in_ready -> UART0_avalon_jtag_slave_agent:rf_source_ready
	wire         uart0_avalon_jtag_slave_agent_rf_source_startofpacket;                      // UART0_avalon_jtag_slave_agent:rf_source_startofpacket -> UART0_avalon_jtag_slave_agent_rsp_fifo:in_startofpacket
	wire         uart0_avalon_jtag_slave_agent_rf_source_endofpacket;                        // UART0_avalon_jtag_slave_agent:rf_source_endofpacket -> UART0_avalon_jtag_slave_agent_rsp_fifo:in_endofpacket
	wire         uart0_avalon_jtag_slave_agent_rsp_fifo_out_valid;                           // UART0_avalon_jtag_slave_agent_rsp_fifo:out_valid -> UART0_avalon_jtag_slave_agent:rf_sink_valid
	wire  [94:0] uart0_avalon_jtag_slave_agent_rsp_fifo_out_data;                            // UART0_avalon_jtag_slave_agent_rsp_fifo:out_data -> UART0_avalon_jtag_slave_agent:rf_sink_data
	wire         uart0_avalon_jtag_slave_agent_rsp_fifo_out_ready;                           // UART0_avalon_jtag_slave_agent:rf_sink_ready -> UART0_avalon_jtag_slave_agent_rsp_fifo:out_ready
	wire         uart0_avalon_jtag_slave_agent_rsp_fifo_out_startofpacket;                   // UART0_avalon_jtag_slave_agent_rsp_fifo:out_startofpacket -> UART0_avalon_jtag_slave_agent:rf_sink_startofpacket
	wire         uart0_avalon_jtag_slave_agent_rsp_fifo_out_endofpacket;                     // UART0_avalon_jtag_slave_agent_rsp_fifo:out_endofpacket -> UART0_avalon_jtag_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_src_valid;                                                          // cmd_mux:src_valid -> UART0_avalon_jtag_slave_agent:cp_valid
	wire  [93:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> UART0_avalon_jtag_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                          // UART0_avalon_jtag_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [2:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> UART0_avalon_jtag_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                  // cmd_mux:src_startofpacket -> UART0_avalon_jtag_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                    // cmd_mux:src_endofpacket -> UART0_avalon_jtag_slave_agent:cp_endofpacket
	...
	wire  [19:0] cpu0_debug_mem_slave_agent_m0_address;                                      // CPU0_debug_mem_slave_agent:m0_address -> CPU0_debug_mem_slave_translator:uav_address
	...
	wire   [2:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> CPU0_debug_mem_slave_agent:cp_channel
	...
	wire  [19:0] sdram_s1_agent_m0_address;                                                  // SDRAM_s1_agent:m0_address -> SDRAM_s1_translator:uav_address
	...
	wire  [93:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> SDRAM_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                      // SDRAM_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> SDRAM_s1_agent:cp_channel
	...
	wire         uart0_avalon_jtag_slave_agent_rp_valid;                                     // UART0_avalon_jtag_slave_agent:rp_valid -> router_002:sink_valid
	wire  [93:0] uart0_avalon_jtag_slave_agent_rp_data;                                      // UART0_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	wire         uart0_avalon_jtag_slave_agent_rp_ready;                                     // router_002:sink_ready -> UART0_avalon_jtag_slave_agent:rp_ready
	wire         uart0_avalon_jtag_slave_agent_rp_startofpacket;                             // UART0_avalon_jtag_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         uart0_avalon_jtag_slave_agent_rp_endofpacket;                               // UART0_avalon_jtag_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [93:0] cpu0_debug_mem_slave_agent_rp_data;                                         // CPU0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire   [2:0] router_src_channel;                                                         // router:src_channel -> CPU0_data_master_limiter:cmd_sink_channel
	...
	wire   [2:0] cpu0_data_master_limiter_cmd_src_channel;                                   // CPU0_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [2:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> CPU0_data_master_limiter:rsp_sink_channel
	...
	wire   [2:0] cpu0_data_master_limiter_rsp_src_channel;                                   // CPU0_data_master_limiter:rsp_src_channel -> CPU0_data_master_agent:rp_channel
	...
	wire   [2:0] router_001_src_channel;                                                     // router_001:src_channel -> CPU0_instruction_master_limiter:cmd_sink_channel
	...
	wire   [2:0] cpu0_instruction_master_limiter_cmd_src_channel;                            // CPU0_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [2:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> CPU0_instruction_master_limiter:rsp_sink_channel
	...
	wire   [2:0] cpu0_instruction_master_limiter_rsp_src_channel;                            // CPU0_instruction_master_limiter:rsp_src_channel -> CPU0_instruction_master_agent:rp_channel
	...
	wire   [2:0] cpu0_data_master_limiter_cmd_valid_data;                                    // CPU0_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [2:0] cpu0_instruction_master_limiter_cmd_valid_data;                             // CPU0_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire         uart0_avalon_jtag_slave_agent_rdata_fifo_src_valid;                         // UART0_avalon_jtag_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] uart0_avalon_jtag_slave_agent_rdata_fifo_src_data;                          // UART0_avalon_jtag_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         uart0_avalon_jtag_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter:in_0_ready -> UART0_avalon_jtag_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                              // avalon_st_adapter:out_0_valid -> UART0_avalon_jtag_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                               // avalon_st_adapter:out_0_data -> UART0_avalon_jtag_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                              // UART0_avalon_jtag_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                              // avalon_st_adapter:out_0_error -> UART0_avalon_jtag_slave_agent:rdata_fifo_sink_error
	...
	wire         sdram_s1_agent_rdata_fifo_src_valid;                                        // SDRAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] sdram_s1_agent_rdata_fifo_src_data;                                         // SDRAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         sdram_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_002:in_0_ready -> SDRAM_s1_agent:rdata_fifo_src_ready
	...
	) uart0_avalon_jtag_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (CPU0_reset_reset_bridge_in_reset_reset),         //                    reset.reset
		.uav_address            (uart0_avalon_jtag_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (uart0_avalon_jtag_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (uart0_avalon_jtag_slave_agent_m0_read),          //                         .read
		.uav_write              (uart0_avalon_jtag_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (uart0_avalon_jtag_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (uart0_avalon_jtag_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (uart0_avalon_jtag_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (uart0_avalon_jtag_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (uart0_avalon_jtag_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (uart0_avalon_jtag_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (uart0_avalon_jtag_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (UART0_avalon_jtag_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (UART0_avalon_jtag_slave_write),                  //                         .write
		.av_read                (UART0_avalon_jtag_slave_read),                   //                         .read
		.av_readdata            (UART0_avalon_jtag_slave_readdata),               //                         .readdata
		.av_writedata           (UART0_avalon_jtag_slave_writedata),              //                         .writedata
		.av_waitrequest         (UART0_avalon_jtag_slave_waitrequest),            //                         .waitrequest
		.av_chipselect          (UART0_avalon_jtag_slave_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) uart0_avalon_jtag_slave_agent (
		.clk                     (clk_0_clk_clk),                                            //             clk.clk
		.reset                   (CPU0_reset_reset_bridge_in_reset_reset),                   //       clk_reset.reset
		.m0_address              (uart0_avalon_jtag_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (uart0_avalon_jtag_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (uart0_avalon_jtag_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (uart0_avalon_jtag_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (uart0_avalon_jtag_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (uart0_avalon_jtag_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (uart0_avalon_jtag_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (uart0_avalon_jtag_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (uart0_avalon_jtag_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (uart0_avalon_jtag_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (uart0_avalon_jtag_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (uart0_avalon_jtag_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (uart0_avalon_jtag_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (uart0_avalon_jtag_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (uart0_avalon_jtag_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (uart0_avalon_jtag_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (uart0_avalon_jtag_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (uart0_avalon_jtag_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (uart0_avalon_jtag_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (uart0_avalon_jtag_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (uart0_avalon_jtag_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (uart0_avalon_jtag_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (uart0_avalon_jtag_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (uart0_avalon_jtag_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (uart0_avalon_jtag_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (uart0_avalon_jtag_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (uart0_avalon_jtag_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (uart0_avalon_jtag_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (uart0_avalon_jtag_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) uart0_avalon_jtag_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                            //       clk.clk
		.reset             (CPU0_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.in_data           (uart0_avalon_jtag_slave_agent_rf_source_data),             //        in.data
		.in_valid          (uart0_avalon_jtag_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (uart0_avalon_jtag_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (uart0_avalon_jtag_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (uart0_avalon_jtag_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (uart0_avalon_jtag_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (uart0_avalon_jtag_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (uart0_avalon_jtag_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (uart0_avalon_jtag_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (uart0_avalon_jtag_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	SEProjetoFinalSingle_mm_interconnect_0_router router (
	...
	SEProjetoFinalSingle_mm_interconnect_0_router_001 router_001 (
	...
	SEProjetoFinalSingle_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (uart0_avalon_jtag_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (uart0_avalon_jtag_slave_agent_rp_valid),         //          .valid
		.sink_data          (uart0_avalon_jtag_slave_agent_rp_data),          //          .data
		.sink_startofpacket (uart0_avalon_jtag_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (uart0_avalon_jtag_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (CPU0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_router_003 router_003 (
	...
	SEProjetoFinalSingle_mm_interconnect_0_router_003 router_004 (
	...
	SEProjetoFinalSingle_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //        clk.clk
		.reset              (CPU0_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                         //        clk.clk
		.reset              (CPU0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (CPU0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SEProjetoFinalSingle_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_0_data      (uart0_avalon_jtag_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (uart0_avalon_jtag_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (uart0_avalon_jtag_slave_agent_rdata_fifo_src_ready), //         .ready
